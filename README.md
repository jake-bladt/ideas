...
A platform that scrapes the web, looking for news sources on a given topic and tracking their updates to create aggregator sites and newsletters. May be able to outsource scraping to webhose.io.
